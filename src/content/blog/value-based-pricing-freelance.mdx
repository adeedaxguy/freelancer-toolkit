...
**The client must be profit-oriented.** Small business owners and companies with clear [revenue goals](https://freeltools.com/blog/revenue-goal-freelancer) respond well to value-based pricing. Clients with fixed, compliance-driven budgets (some government and nonprofit work) may not be the right fit.

---

## The Discovery Process for Value-Based Pricing

Value-based pricing starts in the [discovery call](https://freeltools.com/blog/discovery-call-tips-freelancers) — not the proposal. You need to uncover the numbers before you can set a price based on them.
...
### When does value-based pricing work best for freelancers?

It works best when you can connect your work to a measurable business outcome, run strong discovery, and explain why the result matters more than the time spent delivering it.

### Can freelancers mix value-based and hourly pricing?

Yes. Many freelancers use hourly pricing for discovery or unclear work and value-based pricing for execution when the outcome is easier to define.

### What tools help support a value-based pricing model?

The [Freelancer Rate Calculator](/tools/freelancer-rate-calculator) helps you protect your floor, and the [Revenue Goal Calculator](/tools/revenue-goal-calculator) helps you test whether your pricing model supports the business you want.
