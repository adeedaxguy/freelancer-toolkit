...
seoTitle: "Freelance Retainer Agreement Guide: Terms, Scope, and Pricing"
seoDescription: "Learn how to structure a freelance retainer agreement with monthly scope, fees, unused hours, response times, renewals, and cancellation terms."
date: "2026-06-04"
...
Use the [project cost calculator](https://freeltools.com/tools/project-cost-calculator) to model out different scope scenarios and see how they translate to monthly fees before you take a proposal to a client.
...
It is an agreement where a client pays a recurring fee for access to your time, deliverables, or ongoing services under defined terms.

### What should a retainer agreement include?

Include monthly scope, fee, payment date, included hours or deliverables, rollover rules, response times, exclusions, renewals, and cancellation terms.

### Should unused retainer hours roll over?

Only if you choose. Many freelancers limit or avoid rollover because unlimited rollover can create hidden debt and scheduling problems.

### How do I price a freelance retainer?

Estimate monthly work, multiply by your rate, add management overhead and buffer, then package the result around outcomes rather than only hours.
