...
seoDescription: "A practical guide to setting a freelance hourly rate from income goals, expenses, taxes, billable hours, and market positioning."
date: "2025-05-15"
...
A good rate covers your income goal, taxes, expenses, unpaid admin time, and profit. The right number depends on your service, market, experience, and how many hours you can actually bill.

### Should I charge hourly or fixed price?

Use hourly when scope is uncertain and fixed price when the outcome is clear. Many freelancers calculate an hourly floor first, then convert it into a fixed project quote.

### How many billable hours should I assume?

Do not assume 40 billable hours per week. Many freelancers only bill 15 to 30 hours after sales, admin, revisions, learning, and time off.

### When should I raise my freelance rate?

Raise your rate when demand is strong, your close rate is high, your costs increase, your skill level improves, or your current rate no longer supports your income goal.
