...
### How do I convert an hourly freelance rate into a day rate?

Multiply your hourly rate by the number of billable hours you consider a full day, then sense-check the result against admin time, demand, and market positioning.

### When does a day rate make more sense than hourly pricing?

Day rates work well when the client wants dedicated blocks of time, the work changes within the day, or hourly tracking would create unnecessary friction.

### What tool should I use to set a freelance day rate?

Start with the [Freelancer Rate Calculator](/tools/freelancer-rate-calculator) to find your baseline rate, then use the [Project Cost Calculator](/tools/project-cost-calculator) for project quotes.
