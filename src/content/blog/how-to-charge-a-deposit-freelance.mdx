...
### What deposit percentage is standard for freelancers?

Many freelancers start with 25% to 50% upfront. The right percentage depends on project risk, timeline, and how much capacity you are reserving.

### Are freelance deposits refundable?

That depends on the contract terms. Some deposits are non-refundable reservation fees, while others can be credited or partially refunded in limited situations.

### What tool can help set a project price before asking for a deposit?

Use the [Project Cost Calculator](/tools/project-cost-calculator) to price the work clearly before you choose the deposit amount.
