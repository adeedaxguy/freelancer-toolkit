...
**Rate review clause:** Include a line that rates are reviewed annually. This normalizes [rate increases](https://freeltools.com/blog/how-to-raise-freelance-rates) and prevents the awkward conversation where you've been charging the same rate for 3 years.
...
Only include the amount of work you can deliver consistently each month without squeezing margins. The right number depends on your service, process, and revision expectations.

### Should unused retainer hours roll over?

Usually no, unless rollover is part of the premium value you are intentionally pricing into the agreement. Clear rollover rules prevent confusion and hidden extra work.

### What tool helps price a freelance retainer?

Use the [Retainer Calculator](/tools/retainer-calculator) to turn time, scope, and margin targets into a monthly retainer fee you can defend.
