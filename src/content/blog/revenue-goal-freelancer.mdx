...
### How do freelancers set a realistic revenue goal?

Start with your take-home pay target, add business expenses, add tax reserve, and then pressure-test the total against realistic billable capacity.

### Should a freelance revenue goal include slow months?

Yes. A strong goal accounts for uneven demand, unpaid time, and volatility rather than assuming every month will look the same.

### What tool can help calculate a freelance revenue target?

Use the [Revenue Goal Calculator](/tools/revenue-goal-calculator) to translate income targets, expenses, and pricing into a weekly or monthly revenue number.
