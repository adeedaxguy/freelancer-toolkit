...
Multiply the number of attendees by their approximate hourly cost and the meeting length, then add the extra cost of prep time and lost focus when relevant.

### Which meetings should remote teams cut first?

Start with recurring status meetings that rarely change decisions, meetings with unclear owners, and calls that could be replaced by async updates or recorded walkthroughs.

### What tool can help estimate meeting costs quickly?

Use the [Meeting Cost Calculator](/tools/meeting-cost-calculator) to see the monthly and yearly cost of recurring meetings before you change the calendar.
