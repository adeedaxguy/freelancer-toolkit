...
const textToolData: Array<{
  ...
  { slug: 'ahrefs-content-gap-brief-generator', title: 'Content Gap Brief Generator', keyword: 'content gap brief generator', template: 'content-gap-brief', resultLabel: 'content gap brief', category: 'SEO Tools', seoTitle: 'Content Gap Brief Generator' },
  ...
  { slug: 'semrush-keyword-gap-brief-generator', title: 'Keyword Gap Brief Generator', keyword: 'keyword gap brief generator', template: 'content-gap-brief', resultLabel: 'keyword gap brief', category: 'SEO Tools', seoTitle: 'Keyword Gap Brief Generator' },
  ...
  { slug: 'dataforseo-cost-guard-planner', title: 'DataForSEO Cost Guard Planner', keyword: 'DataForSEO cost guard planner', template: 'content-gap-brief', resultLabel: 'trial-safe research plan', category: 'SEO Tools', seoTitle: 'DataForSEO Cost Guard Planner' },
  ...
  { slug: 'content-decay-refresh-brief-generator', title: 'Content Decay Refresh Brief Generator', keyword: 'content decay refresh brief generator', template: 'gsc-insights-refresh-plan', resultLabel: 'content decay refresh brief', category: 'SEO Tools', seoTitle: 'Content Decay Refresh Brief Generator' },
  { slug: 'gsc-validation-priority-planner', title: 'GSC Validation Priority Planner', keyword: 'GSC validation priority planner', template: 'indexing-issue-triage', resultLabel: 'GSC validation priority plan', category: 'SEO Tools', seoTitle: 'GSC Validation Priority Planner' },
  { slug: 'discovered-not-indexed-recovery-planner', title: 'Discovered Not Indexed Recovery Planner', keyword: 'discovered currently not indexed recovery planner', template: 'indexing-issue-triage', resultLabel: 'discovered page recovery plan', category: 'SEO Tools', seoTitle: 'Discovered Not Indexed Recovery Planner' },
  { slug: 'gsc-sample-url-fix-brief-generator', title: 'GSC Sample URL Fix Brief Generator', keyword: 'GSC sample URL fix brief generator', template: 'indexing-issue-triage', resultLabel: 'sample URL fix brief', category: 'SEO Tools', seoTitle: 'GSC Sample URL Fix Brief Generator' },
  { slug: 'on-page-seo-audit-brief-generator', title: 'On Page SEO Audit Brief Generator', keyword: 'on page SEO audit', template: 'content-gap-brief', resultLabel: 'on page SEO audit brief', category: 'SEO Tools', seoTitle: 'On Page SEO Audit Brief Generator' },
  { slug: 'keyword-density-checker-plan-generator', title: 'Keyword Density Checker Plan Generator', keyword: 'keyword density checker', template: 'answer-box-brief', resultLabel: 'keyword density checker plan', category: 'SEO Tools', seoTitle: 'Keyword Density Checker Plan Generator' },
  ...
  { slug: 'article-interlinking-plan-generator', title: 'Article Interlinking Plan Generator', keyword: 'article interlinking plan generator', template: 'answer-box-brief', resultLabel: 'article internal link plan', category: 'SEO Tools', seoTitle: 'Article Interlinking Plan Generator' },
  ...
  { slug: 'free-seo-tools-stack-builder', title: 'Free SEO Tools Stack Builder', keyword: 'free SEO tools stack builder', template: 'content-gap-brief', resultLabel: 'free SEO tool stack', category: 'SEO Tools', seoTitle: 'Free SEO Tools Stack Builder' },
  { slug: 'image-compressor-seo-brief-generator', title: 'Image Compressor SEO Brief Generator', keyword: 'image compressor online SEO brief generator', template: 'content-gap-brief', resultLabel: 'image compressor SEO brief', category: 'Image & Application File Tools', seoTitle: 'Image Compressor SEO Brief Generator' },
  { slug: 'invoice-generator-page-brief', title: 'Invoice Generator Page Brief', keyword: 'invoice generator page brief', template: 'content-gap-brief', resultLabel: 'invoice generator content brief', category: 'SEO Tools', seoTitle: 'Invoice Generator Page Brief' },
    ...
    bodySections: [
      {
        ...
        body: `Start with the search intent, add the evidence you saw in Google, DataForSEO, or Search Console, then generate a ${data.resultLabel} that can be copied into your content, QA, or outreach workflow.`,
      },
      {
