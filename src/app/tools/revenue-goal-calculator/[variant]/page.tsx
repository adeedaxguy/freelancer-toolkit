...
import RevenueGoalCalculator from '@/components/calculators/RevenueGoalCalculator'

const tool = getToolBySlug('revenue-goal-calculator')!

export function generateStaticParams() {
  return generateStaticParamsForTool('revenue-goal-calculator')
}
...
export async function generateMetadata({ params }: { params: { variant: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `/tools/revenue-goal-calculator/${params.variant}` },
  }
}
