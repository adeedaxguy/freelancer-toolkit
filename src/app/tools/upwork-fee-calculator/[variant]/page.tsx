...
import UpworkFeeCalculator from '@/components/calculators/UpworkFeeCalculator'

const tool = getToolBySlug('upwork-fee-calculator')!

export function generateStaticParams() {
  return generateStaticParamsForTool('upwork-fee-calculator')
}
...
export async function generateMetadata({ params }: { params: { variant: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `/tools/upwork-fee-calculator/${params.variant}` },
  }
}
