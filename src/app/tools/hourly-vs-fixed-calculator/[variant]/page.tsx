...
import HourlyVsFixedCalculator from '@/components/calculators/HourlyVsFixedCalculator'

const tool = getToolBySlug('hourly-vs-fixed-calculator')!

export function generateStaticParams() {
  return generateStaticParamsForTool('hourly-vs-fixed-calculator')
}
...
export async function generateMetadata({ params }: { params: { variant: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `/tools/hourly-vs-fixed-calculator/${params.variant}` },
  }
}
