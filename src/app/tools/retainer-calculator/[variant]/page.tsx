...
import RetainerCalculator from '@/components/calculators/RetainerCalculator'

const tool = getToolBySlug('retainer-calculator')!
...
export async function generateMetadata({ params }: { params: { variant: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `/tools/retainer-calculator/${params.variant}` },
  }
}
