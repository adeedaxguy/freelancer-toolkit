...
import ProposalGenerator from '@/components/calculators/ProposalGenerator'

const tool = getToolBySlug('proposal-generator')!

export function generateStaticParams() {
  return generateStaticParamsForTool('proposal-generator')
}
...
export async function generateMetadata({ params }: { params: { variant: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `/tools/proposal-generator/${params.variant}` },
  }
}
