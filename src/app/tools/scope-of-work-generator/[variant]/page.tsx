...
import ScopeOfWorkGenerator from '@/components/calculators/ScopeOfWorkGenerator'

const tool = getToolBySlug('scope-of-work-generator')!

export function generateStaticParams() {
  return generateStaticParamsForTool('scope-of-work-generator')
}
...
export async function generateMetadata({ params }: { params: { variant: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `/tools/scope-of-work-generator/${params.variant}` },
  }
}
