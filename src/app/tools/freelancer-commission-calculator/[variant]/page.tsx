...
import FreelancerCommissionCalculator from '@/components/calculators/FreelancerCommissionCalculator'

const tool = getToolBySlug('freelancer-commission-calculator')!

export function generateStaticParams() {
  return generateStaticParamsForTool('freelancer-commission-calculator')
}
...
export async function generateMetadata({ params }: { params: { variant: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `/tools/freelancer-commission-calculator/${params.variant}` },
  }
}
...
export default function Page({ params }: { params: { variant: string } }) {
  ...
  return (
    <ToolPageShell tool={tool} variantLabel={variant.label}>
      <FreelancerCommissionCalculator />
    </ToolPageShell>
  )
}
